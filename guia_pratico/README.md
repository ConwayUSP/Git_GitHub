...
> Esse é o início da sua jornada em busca de aprender Git & GitHub. Nesse guia prático, aprenderemos do zero como usar essas poderosísismas ferramentas, desde a sua instalação, até fluxos de trabalho mais complexos que você certamente irá encarar ao longo da sua vida como dev. Lembrando que, se você já se sente confiante usando essas ferramentas, pode acessar diretamente o [Guia de Comandos](../guia_comandos/README.md) para consultar os comandos mais importantes do Git, ou o [Glossário de Conceitos](../glossario_conceitos/README.md) para relembrar os principais termos relacionados a essas ferramentas.

Voltar ao [README Principal](../README.md)

## Sumário

1. [Configuração Inicial](00_configuracao_inicial.md)
2. [Por Trás dos Panos](01_por_tras_dos_panos.md)
3. [Criando um Repositório](02_criando_repositorio.md)
4. [Fazendo Commits](03_fazendo_commits.md)
5. [Manipulando Branchs](04_manipulando_branchs.md)
6. [Navegando no Repositório](05_navegando_repositorio.md)
7. [Unindo Branchs](06_unindo_branchs.md)
8. [Alterando o Histórico](07_alterando_historico.md)
9. [Trabalhando em equipe](08_trabalhando_em_equipe.md)

...
![explorador aberto com opção de abrir com o VSCode](./prints/image-1.png)
...
![VSCode aberto com a opção de abrir terminal](./prints/image-2.png)
...
![GitHub Desktop aberto com a opção de criar novo repositório](./prints/image-3.png)
...
- **Licença**: documento legal que define os termos de uso, distribuição e modificação do seu projeto; existem diversos tipos de licença, cada uma com suas particularidades, mas como não iremos trabalhar com nenhuma linguagem específica, podemos simplesmente *ignorar* essa opção também.
...
![formulário para criar novo repositório](./prints/image-4.png)

...
![repositório sendo mostrado como uma arvore, com três commits no galho main e dois no galho teste](./assets/commit-graph.png)
...
![print do comando git log, mostrando os commits e seus respectivos hashes](./assets/commits-hashs.png)
